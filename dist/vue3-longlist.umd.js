(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue3-longlist"] = factory(require("vue"));
	else
		root["vue3-longlist"] = factory(root["Vue"]);
...
/* harmony default export */ var srcvue_type_script_lang_ts = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
    ...
    setup: function (props, ctx) {
        ...
        var PAGESIZE = WINDOWHEIGHT / Number(props.itemHeight);
        //defines the current page height
        var pageY = 0;
        //define current number of pages
        var currPage = 1;
        var data = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(props.list.slice(0, currPage * PAGESIZE));
        //scroll render
        function render() {
        ...
        return { props: props, ctx: ctx, data: data };
    },
}));
...
var p = {
    install: function (vue) {
        vue.component('llist', longList_src);
    }
};
/* harmony default export */ var longList = (p);

// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (longList);
...
//# sourceMappingURL=vue3-longlist.umd.js.map